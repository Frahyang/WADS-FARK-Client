...
const AdminTicketPopUp: React.FC<Props> = ({ isOpen, onClose, ticket, onUpdate, onDelete, onStatusChange, onPriorityChange }) => {
  ...
  const statusOptions: StatusType[] = ['In Progress', 'Completed', 'Unseen'];
          ...
          <div className="bg-gray-50 rounded-xl p-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-gray-900 font-medium">{ticket.createdAt}</p>
              </div>
